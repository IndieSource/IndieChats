...
<div class="content">
	...
	<div class="figure row">
		<div class="figure col-sm-6">
			<a href="images/info/desktop/iphone-desktop.png" target="_blank" class="lightbox" data-caption="<%= application.name %> Mobile"><img src="images/info/desktop/iphone-desktop.png" /></a>
